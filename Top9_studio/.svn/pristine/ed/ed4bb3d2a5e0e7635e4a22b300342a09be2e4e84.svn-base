 ...
 */
public abstract class WrapNotAndRefreshFragment<T> extends WrapNotAndHandleFragment implements LoadingView.OnFailedClickListener, SwipeRefreshLayout.OnRefreshListener {
    //刷新组件
...
/*
    ...
    */
    ...
    public void onHandleUpdate(Object obj) {
        Tools.log_i(WrapNotAndRefreshFragment.class, "onHandleUpdate", "");
    ...
    public void onHandleNo() {
        Tools.log_i(WrapNotAndRefreshFragment.class, "onHandleNo", "");
        if (Tools.isEmpty(data))
            loading.loadSuccess();
        cancelRefresh();
    ...
    public void onHandleHistory(Object obj) {
        Tools.log_i(WrapNotAndRefreshFragment.class, "onHandleHistory", "");
        if (Tools.isEmpty(data)) {
            loading.loadSuccess();
        }
        cancelRefresh();
    ...
    public void onHandleFailed() {
        Tools.log_i(WrapNotAndRefreshFragment.class, "onHandleFailed", "");
        if (Tools.isEmpty(data)) {
            loading.loadFailed();
        } else {
