...
/* http://192.168.1.112:8080/DemoServer/servlet/HtmlCommentServlet */
     ...
     * 排行榜默认请求条数
     */
    public static final int RANKING_PAGESIZE = 10;
    /**
     * 点赞排行榜
     *
     * @param pageSize 请求条数
     * @method get
     */
    public static final String URL_RANKING_GOOD = URL_BASE + "user/thumbUpRanking";
    /**
     * 回复排行榜
     *
     * @param pageSize 请求条数
     * @method get
     */
    public static final String URL_RANKING_REPLY = URL_COMMENT_BASE + "replyRanking";
}
