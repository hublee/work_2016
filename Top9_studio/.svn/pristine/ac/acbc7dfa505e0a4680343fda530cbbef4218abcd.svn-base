...
//    private OnRefreshListener mListener;
    ...
    private AnimationListener mRefreshListener = new AnimationListener() {
        ...
        public void onAnimationEnd(Animation animation) {
            if (mRefreshing) {
                ...
                if (mNotify) {
                    if (mListener != null) {
                        if (SwipeRefreshLayoutDirection.TOP == mDirection){
    ...
    public SwipeRefreshLayout(Context context, AttributeSet attrs) {
        ...
        setColorSchemeResources(R.color.red,R.color.yellow,R.color.blue);
    }
    ...
    private void createProgressView() {
        mCircleView = new CircleImageView(getContext().getApplicationContext(), CIRCLE_BG_LIGHT, CIRCLE_DIAMETER / 2);
        mProgress = new MaterialProgressDrawable(getContext().getApplicationContext(), this);
