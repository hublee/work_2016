...
public class OverScrollView extends ScrollView {
    ...
    protected void onDetachedFromWindow() {
        ...
        onDestroy();
        Tools.log_i(OverScrollView.class,"onDetachedFromWindow","");
    }

    @Override
    protected void detachViewFromParent(View child) {
        super.detachViewFromParent(child);
        Tools.log_i(OverScrollView.class,"detachViewFromParent","");
    }
    ...
    private OverScrollWarpLayout.OnScrollChange onScrollChange;

    public void setOnScrollChange(OverScrollWarpLayout.OnScrollChange onScrollChange) {
    ...
    private void initOverScrollLayout() {
        ...
        if (mContentLayout == null) {
            ...
            mContentLayout.setOnScrollChange(onScrollChange);
            // 移除ScrollView所有视图
            this.removeAllViews();
